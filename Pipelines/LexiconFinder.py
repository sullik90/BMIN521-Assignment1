...
class LexiconFinder(object):
    ...
    def searchForDrugsInTweets(self, tweets: DataFrame) -> DataFrame:
        ...
        :return: the dataframe with 2 additional columns, prediction: 0 if the tweet does not mention a drug, 1 otherwise; drug predicted: the list of names of drugs mentioned, tokenized, empty if no drug name was found 
        """
